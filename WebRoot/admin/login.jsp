...
<BODY onload="f1.uname.focus();">
 <FORM name=f1 action="/wenjx/wenjx?ac=login" method=post>
<TABLE cellSpacing=0 cellPadding=0 width=651 align=center border=0>
  ...
  <TR>
    <TD height=351><TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        ...
        <TR>
          <TD width=15 background=/wenjx/admin/images/ileft.gif height=43></TD>
          <TD width=620 background=/wenjx/admin/images/i_topbg2.gif></TD>
          <TD width=16><IMG height=43 src="/wenjx/admin/images/iright.gif" 
            width=16></TD>
        </TR>
        <TR>
          <TD background=/wenjx/admin/images/ileftbg.gif></TD>
          <TD vAlign=center background=/wenjx/admin/images/bg.gif height=279><TABLE height=109 cellSpacing=0 cellPadding=0 width=369 align=center 
            border=0>
              <TBODY>
              
              <TR>
                <TD width=155><IMG height=140 
                  src="/wenjx/admin/images/logo.jpg" width=155 useMap=#Map 
                  border=0></TD>
                <TD vAlign=top align=left width=214><TABLE cellSpacing=0 cellPadding=0 width=167 border=0>
                    ...
                    <TR>
                      <TD vAlign=bottom width=167 height=30><A 
                        ...
                        height=19 src="/wenjx/admin/images/adminsyteam.gif" 
                    ...
                    <TR>
                      <TD height=123><TABLE height=109 cellSpacing=0 cellPadding=0 
                        align=center border=0>
                              ...
                              src="/wenjx/admin/images/id.gif" width=43></DIV></TD>
                              ...
                              src="/wenjx/admin/images/pass.gif" 
                            width=43></DIV></TD>
                              ...
                              <TR>
                                <TD vAlign=center colSpan=2 height=25><DIV align=center>
                                    <INPUT type=image 
                              src="/wenjx/admin/images/b_login.gif" name=denglu>
                                    <IMG style="CURSOR: hand" 
                              onclick=document.form1.reset() height=21 
                              src="/wenjx/admin/images/b_clean.gif" width=73> </DIV></TD>
                              </TR>
          ...
          <TD background=/wenjx/admin/images/irightbg.gif></TD>
        </TR>
        <TR>
          <TD><IMG height=29 src="/wenjx/admin/images/i_bottom_left.gif" 
            width=15></TD>
          <TD background=/wenjx/admin/images/i_bottom_bg.gif></TD>
          <TD width=16><IMG height=29 
            src="/wenjx/admin/images/i_bottom_right.gif" 
      width=16></TD>
        </TR>
        </TBODY>
      </TABLE></TD>
