...
<%
HashMap m = (HashMap)session.getAttribute("user");
CommDAO dao = new CommDAO();
  m = dao.select("select * from sysuser where id="+m.get("id")).get(0);
 %>
 <FORM name=regform  style="display: inline;" action="/wenjx/wenjx?ac=upreg&id=<%=m.get("id") %>" method=post>
<CENTER>
                ...
                <tr>
                  <td height="27" colspan="2" class="zise">“人人为我 我为人人”，昵图理解您的需要，注册先送100下载分。<span class="green">抽空也来分享点好东东给大家吧！</span></td>
                    ...
                    <TR>
                      ...
                      <TD width="50%" colSpan=2 class="huiz tahoma"><INPUT readonly="readonly" id=username  value="<%=m.get("uname") %>" 
                      ...
                      <TD class="huiz tahoma" align=right width="18%"><label wd3_selection_help="selection">密码</label>
                        ：</TD>
                      <TD width="50%" colSpan=2 class="huiz tahoma"><INPUT id=username   value="<%=m.get("upass") %>" 
...
女
                      ...
                      <TD width="50%" colSpan=2 class="huiz tahoma"><INPUT id=username   value="<%=m.get("age") %>" 
                         maxLength=20 name=age></TD>
                        </TR>
                        
                        <TR>
                      <TD class="huiz tahoma" align=right width="18%">职业                        ：</TD>
                      <TD width="50%" colSpan=2 class="huiz tahoma"><INPUT name=uposition  value="<%=m.get("uposition") %>"  size="45"></TD>
                        </TR>
                        
                        <TR>
                      <TD class="huiz tahoma" align=right width="18%">地址                        ：</TD>
                      <TD width="50%" colSpan=2 class="huiz tahoma"><INPUT name=addrs  value="<%=m.get("addrs") %>"  size="45"></TD>
                        </TR>
                        
                        <TR>
                      <TD class="huiz tahoma" align=right width="18%">email                        ：</TD>
                      <TD width="50%" colSpan=2 class="huiz tahoma"><INPUT name=email   value="<%=m.get("email") %>" 
                         size="45"></TD>
                        </TR>
                    <TR>
                      <TD height=35></TD>
